...
export class View_NavBarComponent0 extends import1.AppView<import0.NavBarComponent> {
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    if (((token === import30.RouterLinkWithHref) && ((16 <= requestNodeIndex) && (requestNodeIndex <= 17)))) { return this._RouterLinkWithHref_16_3.context; }
    if (((token === import31.RouterLinkActive) && ((16 <= requestNodeIndex) && (requestNodeIndex <= 17)))) { return this._RouterLinkActive_16_4.context; }
    if (((token === import30.RouterLinkWithHref) && ((21 <= requestNodeIndex) && (requestNodeIndex <= 22)))) { return this._RouterLinkWithHref_21_3.context; }
    if (((token === import31.RouterLinkActive) && ((21 <= requestNodeIndex) && (requestNodeIndex <= 22)))) { return this._RouterLinkActive_21_4.context; }
    if (((token === import30.RouterLinkWithHref) && ((48 <= requestNodeIndex) && (requestNodeIndex <= 49)))) { return this._RouterLinkWithHref_48_3.context; }
    if (((token === import30.RouterLinkWithHref) && ((51 <= requestNodeIndex) && (requestNodeIndex <= 52)))) { return this._RouterLinkWithHref_51_3.context; }
    ...
    if (((token === import28.TemplateRef) && (75 === requestNodeIndex))) { return this._TemplateRef_75_5; }
